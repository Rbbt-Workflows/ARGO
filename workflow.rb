...
module ARGO
 ...
 def self.link_FASTA(file)
  ...
  self.nextflow Rbbt.modules["sanger-wgs-variant-calling"]["sanger-wgs-variant-calling"].find(:lib)

  input "ref_genome_fa-generateBas", :file, "Ill defined Nextflow parameter", nil, :nofile => true
  self.nextflow Rbbt.modules["sanger-wxs-variant-calling"]["sanger-wxs-variant-calling"].find(:lib)
